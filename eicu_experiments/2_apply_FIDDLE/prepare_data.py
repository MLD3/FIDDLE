...
outcome, T = args.outcome, args.T

data_path = '/scratch/wiensj_root/wiensj/shared_data/FIDDLE_project/'
pop_path = 'population/{}_{}h.csv'.format(outcome, T)
...
data.to_csv(data_path + 'features/{}_{}h/input_data.csv'.format(outcome, T), index=False)
